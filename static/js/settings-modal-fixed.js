// filepath: c:\Users\taghi\.anaconda\static\js\settings-modal.js
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function switchSettingsTab(tabId) {
      ...
      // Load user token usage data with improved error handling
    function loadUserUsageData() {
        fetch('/api/usage/check')
            .then(response => {
                ...
                // Get the response as text first to handle potential HTML responses
                return response.text().then(text => {
                    try {
                        // Attempt to parse as JSON
                        return JSON.parse(text);
                    } catch (e) {
                        // If parsing fails, it's probably HTML (like a login page)
            ...
            .then(data => {
                try {
                    ...
                    if (tokensUsedEl) {
                        tokensUsedEl.textContent = data.current_usage;
                    }
      ...
      // Load referral data with improved error handling
    function loadReferralData() {
        ...
        fetch('/api/referral/code')
          ...
          // Also load referral stats if applicable with improved error handling
